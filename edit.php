...
{	
	...
	if(empty($imie) || empty($nazwisko) || empty($telefon)) {	
		...
		//updating the table
		$result = mysqli_query($mysqli, "UPDATE lekarz SET Imie='$imie',Nazwisko='$nazwisko',telefon='$telefon' WHERE id_Lekarz=$id");
...
$result = mysqli_query($mysqli, "SELECT * FROM lekarz WHERE id_Lekarz=$id");
